...
class Tenant(Base, TimestampMixin):
    ...
    commercial_plan_status: Mapped[str] = mapped_column(String(30), default="not_purchased", nullable=False, index=True)
...
class Product(Base, TimestampMixin):
    ...
    barcode: Mapped[str] = mapped_column(String(120), nullable=False, index=True)
    barcode_type: Mapped[str] = mapped_column(String(20), nullable=False, default="code128")
    external_barcode: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
...
class MarketingProspect(Base, TimestampMixin):
    ...
    main_goal: Mapped[str] = mapped_column(String(40), default="ventas", nullable=False, index=True)
    ...
    status: Mapped[str] = mapped_column(String(30), default="nuevo", nullable=False, index=True)
    status_history_json: Mapped[str] = mapped_column(Text, default="[]", nullable=False)
...
class PosSale(Base):
    ...
    payment_mode: Mapped[str] = mapped_column(String(20), nullable=False, default="subscription")
    currency: Mapped[str] = mapped_column(String(10), default="MXN", nullable=False)
